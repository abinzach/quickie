...
function Sidebar({
  ...
  return (
    ...
    >
      <button onClick={toggleSidebar} className="self-start py-2 mb-2">
        {isOpen ? (
          <FaAngleLeft
            size={30}
            className={`angle-icon ${isPressed ? "rotate-left" : ""}`}
          />
        ) : (
          <FaAngleRight
            size={30}
            className={`angle-icon ${isPressed ? "rotate-right" : ""}`}
          />
        )}
      </button>
      <div
      ...
      >
        {isOpen && (
          <>
            ...
            <h2 className="text-lg font-semibold mt-10 mb-4">Settings</h2>
            <div className="mb-4">
